                  ...
                  children: [
                    ...
                    Obx(() => Container(
                      ...
                      child: TextField(
                          ...
                          obscureText:
                          controller.resetPasswordInvisibleLogin.value,
                          ...
                          decoration: InputDecoration(
                              ...
                              suffixIcon: GestureDetector(
                                onTap: () {
                                  controller.changePasswordVisibilityReset(
                                      !controller
                    ...
                    Obx(() => Container(
                      ...
                      child: TextField(
                          ...
                          obscureText:
                          controller.confirmPasswordInvisibleLogin.value,
                          keyboardType: TextInputType.visiblePassword,
                          cursorColor: AppColors.mainColor,
                          style: kThemeData.textTheme.bodyLarge,
                          onSubmitted: (_) {
                          ...
                          decoration: InputDecoration(
                              ...
                              suffixIcon: GestureDetector(
                                onTap: () {
                                  controller.changePasswordVisibilityConfirm(
                                      !controller
                    ...
                    ButtonsWidget(
                      name: 'Reset',
                      onPressed: controller.progressBarStatusReset.value == false
                          ? () async {
                        try {
                          controller.progressBarStatusReset.value = true;
                          if (await controller
                          ...
                          controller.progressBarStatusReset.value = false;
                        }
                      }
                          : () {},
                    ),
