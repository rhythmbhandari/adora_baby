...
class SearchView extends GetView<ShopController> {
  ...
  final RefreshController _refreshControllerSearch =
  ...
  Widget build(BuildContext context) {
    if (Get.arguments != null) {
      controller.allProductsSearched.value = Get.arguments;
    }
    return WillPopScope(
      onWillPop: () async {
        controller.selectedStages.value = 10;
                    ...
                    child: Stack(
                      children: [
                        SmartRefresher(
                          ...
                          controller: _refreshControllerSearch,
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Obx(() => controller
                                          .allProductsSearched.isNotEmpty
                                      ? ListView.builder(
                                          physics:
                                              NeverScrollableScrollPhysics(),
                                          shrinkWrap: true,
                                          itemCount: controller
                                              .allProductsSearched.length,
                                          itemBuilder:
                                                              ...
                                                              Container(
                                                                ...
                                                                child: Center(
                                                                  child: Image
                                                                      .network(
                                                                    controller
                                                                            .allProductsSearched[index]
                                                                            .productImages
                                                                            .isEmpty
                                                                        ? 'https://sternbergclinic.com.au/wp-content/uploads/2020/03/placeholder.png'
                                                                        : '${controller.allProductsSearched[index].productImages?.firstWhere(
  ...
  void filterPressed(BuildContext context) {
    if (controller.selectedStages.value == 10) {
      controller.searchProducts(true,
          isOrdered: true,
          ordering: controller.selectedFilter.value == 1
              ? 'regular_price'
              : '-regular_price',
